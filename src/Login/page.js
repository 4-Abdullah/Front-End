...
return(
  <main> 
    <img src={logo} alt='Login'  className="w-full h-screen object-cover"/>
      ...
      {showPassword? 
        ...
        <div className="relative">  
        <button  onClick={onLogin} className="absolute shrink-0 w-1/2 h-14 -bottom-20 left-1/2 -translate-x-1/2 bg-indigo-600 hover:bg-indigo-700 text-slate-800 font-bold py-2 px-4 rounded-full">
           Login
          <Toaster /> 
        </button>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 py-2 bg-gray-800 opacity-70">
            <h3 className="text-xl text-white  font-bold">Welcome! To E-Shop with MernStack. </h3>
            <p className="mt-2 text-sm text-gray-300">This is the Login Page.</p>
            <Link to={"/"}>
            <p className="absolute text-l text-black bottom-8 right-2 -translate-x-1/2 -translate-y-1/2 font-italic" >Back to E-Shop</p></Link>
            <Link to={"/Signup"}>
             <button type='submit' className="absolute shrink-0 w-32 bottom-0 -right-1 -translate-x-1/2 -translate-y-1 bg-indigo-600 hover:bg-indigo-700 text-slate-800 font-bold py-2 px-4 rounded-full">
              Register
             </button>
            </Link>
        </div>
