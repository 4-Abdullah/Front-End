      ...
      {showPassword? 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" onClick={e => pressShow(e)} width="18" height="18" fill="indigo" className="absolute bi bi-eye-slash top-1/2 right-2 -translate-y-1/2" viewBox="0 0 16 16">
          ...
          <div className="absolute bottom-0 left-0 right-0 px-4 py-2 bg-gray-800 opacity-70">
              ...
              <Link to="/"><p className="absolute text-l text-black bottom-8 right-2 -translate-x-1/2 -translate-y-1/2 font-italic" >Back to E-Shop</p></Link>
              <Link to="/Login"><button type='submit' className="absolute shrink-0 w-32 bottom-0 -right-1 -translate-x-1/2 -translate-y-1 bg-indigo-600 hover:bg-indigo-700 text-slate-800 font-bold py-2 px-4 rounded-full">
               Login
              </button>
              </Link>
          </div>
